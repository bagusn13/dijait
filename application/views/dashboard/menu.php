...
<ul class="p-b-54">
  ...
  <li class="p-t-4">
    <a href="<?php echo base_url('cart') ?>" class="s-text13 active1">
      <i class="fa fa-shopping-cart"></i> Keranjang Belanja
    </a>
  </li>
  <li class="p-t-4">
    <a href="<?php echo base_url('dashboard/orderHistory') ?>" class="s-text13 active1">
  ...
  <li class="p-t-4">
    <a href="<?php echo base_url('login/logout') ?>" class="s-text13 active1">
