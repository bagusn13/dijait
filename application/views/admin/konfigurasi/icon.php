<div class="container">
  ...
  <div class="form-group">
    <label class="col-form-label">Upload Icon Baru</label>
    <input type="file" name="icon" class="form-control-file" placeholder="Upload Icon Baru" value="<?php echo $konfigurasi->icon ?>" required>
