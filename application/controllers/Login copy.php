...
class Login extends CI_Controller
{
  ...
  public function google()
  {
    if (isset($_GET['code'])) {
      ...
      if ($this->googleplus->getAuthenticate()) {
        ...
        $userID         = $this->pelanggan_model->checkUserGooglePlus($userData);
        $check          = $this->pelanggan_model->authentication($email, $oauth_uid);
  ...
  public function facebook()
  {
    ...
    if ($this->facebook->is_authenticated()) {
      ...
      $userID         = $this->pelanggan_model->checkUserFacebook($userData);
      $check          = $this->pelanggan_model->authentication($email, $oauth_uid);
      $id_pelanggan   = $check->id_pelanggan;
      $nama_pelanggan = $check->nama_pelanggan;
